const SCHEDULE_ASSESSMENT_NEW = {
  
    SCHEDULE_ASSESSMENT_NEW_EMAIL_TEMPLATE: {
      ...
      Body: `<!DOCTYPE html>
                ...
                <body>
                    ...
                    <div>
                        ...
                        <br>        
                        <p style="margin-top:0;margin-bottom:0;">The RCSA# [[ScheduleAssessmentCode_1]] is scheduled for your Department. Please login to the application for further information.<br><br>
  ...
  module.exports = {
    SCHEDULE_ASSESSMENT_NEW: SCHEDULE_ASSESSMENT_NEW,
  };
