const RE_SUBMIT_REPORTEE = {
    RE_SUBMIT_REPORTEE_EMAIL_TEMPLATE: {
      Subject: "Incident Re-submitted for internal review : [[IncidentCode]]",
      Body: `<!DOCTYPE html>
      <html>
        <body>
          <head>
          ...
          <div>
            <div style="width: 650pt;margin: auto;padding: 25pt;font-size: 15pt;font-family: Calibri;line-height: 1.5;">
              ...
              An Incident has been Re-submitted with Incident ID  [[IncidentCode_1]] <br><br>
  ...
  module.exports = {
    RE_SUBMIT_REPORTEE: RE_SUBMIT_REPORTEE,
  };
