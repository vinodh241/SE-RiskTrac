...
const APP_SERVER = {
    ...
    APP_START_PORT          : 46001,         // Port for API server run on
    ...
    ALLOWED_ORIGINS         : ["http://localhost:5000","http://localhost:46004","http://localhost:46002"]      // Alowed origins list, else we will get CORS policy error.
};
