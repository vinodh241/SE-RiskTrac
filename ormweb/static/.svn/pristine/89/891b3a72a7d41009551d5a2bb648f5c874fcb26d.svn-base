...
@Component({
  selector: 'app-overall-inherent-risk-rating',
  templateUrl: './overall-inherent-risk-rating.component.html',
  styleUrls: ['./overall-inherent-risk-rating.component.scss']
})
export class OverallInherentRiskRatingComponent implements OnInit {
...
@ViewChild(MatSort) sort: MatSort;
 ...
 constructor( private service: ControlAutomationScoreService, 
       ...
       let data = {
           ...
           "result": {
               "ControlAutomationScores": [
                   {
                       "RatingName": "Automation is not Applicable",
                       "StatusID": "1",
                       "StatusName": "Enabled",
                       "RatingScore": "1",
                       "RateID": 1
...
process(data: any): void {
   if (data.success == 1) {
       if (data.result.ControlAutomationScores.length > 0) {
           let docs = data.result.ControlAutomationScores;
           if (docs) {
               let id = 0;
