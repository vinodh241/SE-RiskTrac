...
const APP_SERVER = {
     ...
     */
    ENVIRONMENT_NAME        : "QA",
    APP_START_PORT          : 6003,         // Port for API server run on
    ...
    ALLOWED_ORIGINS         : ["https://serisktrac.secureyes.net","http://serisktrac.secureyes.net","http://localhost:6003","http://localhost:8080","http://10.0.1.32:8080"]      // Allowed origins (add your Nginx URL for CORS)
};
