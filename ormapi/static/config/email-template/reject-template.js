const REJECT_CHECKER = {
    REJECT_CHECKER_EMAIL_TEMPLATE: {
      Subject: "Incident Rejected by the Incident Unit Head : [[CheckerUser]]",
      Body: `<!DOCTYPE html>
      <html>
        <body>
          <head>
          ...
          <div>
            <div style="width: 650pt;margin: auto;padding: 25pt;font-size: 15pt;font-family: Calibri;line-height: 1.5;">
              ...
              The incident  [[IncidentCode_1]] reported by you is Rejected by the Incident Unit Head : [[CheckerUser_1]] . Please find the review comment in  the incident form.  <br><br>
