const SELF_ASSESSMENT_REJECTED = {
  
    SELF_ASSESSMENT_REJECTED_EMAIL_TEMPLATE: {
      Subject: "RCSA Assessment has been Rejected for your Department: [[ScheduleAssessmentCode]]",    
      Body: `<!DOCTYPE html>
                <html>
                <body>
                    <head>
                    ...
                    <div>
                        ...
                        <br>        
                        <p style="margin-top:0;margin-bottom:0;">The Submitted details under RCSA# [[ScheduleAssessmentCode_1]] by your department has been Rejected by the reviewer user. Kindly login to the application to make necessary action and Resubmit the same.</p>
                        <br>    
                        <p style="margin-top:0;margin-bottom:0;">
