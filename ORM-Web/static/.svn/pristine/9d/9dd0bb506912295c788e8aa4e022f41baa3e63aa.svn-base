...
@Component({
  selector: 'app-control-automation-score',
  templateUrl: './control-automation-score.component.html',
  styleUrls: ['./control-automation-score.component.scss']
})

export class ControlAutomationScoreComponent implements OnInit {
