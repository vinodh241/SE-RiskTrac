...
@Component({
  selector: 'app-control-frequency-score',
  templateUrl: './control-frequency-score.component.html',
  styleUrls: ['./control-frequency-score.component.scss']
})
export class ControlFrequencyScoreComponent implements OnInit {
...
@ViewChild(MatSort) sort: MatSort;
 ...
 constructor( private service: ControlFrequencyScoreService, 
...
process(data: any): void {
   if (data.success == 1) {
       if (data.result.ControlFrequencies.length > 0) {
           let docs = data.result.ControlFrequencies;
           if (docs) {
               let id = 0;
