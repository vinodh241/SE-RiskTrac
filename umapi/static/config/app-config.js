...
const APP_SERVER = {
    ...
    ALLOWED_ORIGINS         : ["http://serisktrac.secureyes.net","https://serisktrac.secureyes.net","http://localhost:46002","http://localhost:8080","http://10.0.1.32:8080"]       // Allowed origins (add your Nginx URL for CORS)
};
